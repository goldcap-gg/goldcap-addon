...
GC.Locales.enUS = {
  ...
  [", %d hidden: hard to resell or under your min profit"] = ", %d hidden: hard to resell or under your min profit",
  ...
  ["GOLDCAP"] = "GOLDCAP",
  ["GoldCap: checked live -- a deal, but the buy needs %s"] = "GoldCap: checked live -- a deal, but the buy needs %s",
  ["HOLDING %d"] = "HOLDING %d",
  ...
  ["for the %d this buy would take — more than your per-buy wallet limit allows"] = "for the %d this buy would take — more than your per-buy wallet limit allows",
  ["fresh"] = "fresh",
  ["hold"] = "hold",
  ["ilvl %d"] = "ilvl %d",
  ...
  ["no price"] = "no price",
  ["not enough gold on this character -- this buy needs %s"] = "not enough gold on this character -- this buy needs %s",
