...
GC.Locales.esMX = {
  ...
  ["%s units across %d prices"] = "%s unidades en %d precios",
  ...
  ["No answer from the auction house yet -- still listening for a minute"] =
    "Aún sin respuesta de la casa de subastas -- seguimos escuchando un minuto",
  ...
  ["This item's last post may still go up -- wait a minute"] =
    "La última publicación de este objeto aún puede salir -- espera un minuto",
  ...
  ["past the first %d prices read (%s units)"] =
    "más allá de los primeros %d precios leídos (%s unidades)",
  ["placing bid..."] = "pujando...",
  ...
  ["your price · %s units ahead of you"] = "tu precio · %s unidades por delante",
  ["your price · at least %s units ahead of you"] = "tu precio · al menos %s unidades por delante",
  ["your price · first in line"] = "tu precio · primero en la fila",
  ["yours"] = "tuyo",
  ["~%dd to reach you at today's pace"] = "~%d d hasta tu turno al ritmo de hoy",
  ["~%dh to reach you at today's pace"] = "~%d h hasta tu turno al ritmo de hoy",
  ...
  ["Paused while the Sell tab is open: it prices your bags through the same search. Go back to Deals and Auto carries on."] =
    "En pausa mientras la pestaña Vender está abierta: pone precio a tus bolsas con la misma búsqueda. Regresa a Ofertas y Auto sigue.",
  ...
  ["Paused while the BUY tab is open: it looks up prices through the same search. Go back to Deals and Auto carries on."] =
    "En pausa mientras la pestaña BUY está abierta: consulta precios con la misma búsqueda. Regresa a Ofertas y Auto sigue.",
