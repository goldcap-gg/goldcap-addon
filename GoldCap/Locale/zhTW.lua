...
GC.Locales.zhTW = {
  ...
  ["No answer from the auction house yet -- still listening for a minute"] = "拍賣場尚未回應 -- 再等待一分鐘",
  ...
  ["This item's last post may still go up -- wait a minute"] = "此物品上一次上架可能仍會成功 -- 請等待一分鐘",
